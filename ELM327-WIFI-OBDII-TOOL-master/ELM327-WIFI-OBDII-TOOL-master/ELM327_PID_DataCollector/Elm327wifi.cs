...
namespace ELM327_PID_DataCollector
{
    public class Elm327wifi
    {
        ...
        private TcpClientOBD serialPort;
        ...
        private void GetAvailablePIDs()
        {
            ...
            serialPort = new TcpClientOBD(port);

            serialPort.PidMessageArrived += Client_PidMessageArrived;
            serialPort.OBDdeviceReady += Client_OBDdeviceReady;

            serialPort.StartOBDdev();
        }
        ...
        private void StartFreeMode()
        {
            ...
            serialPort.StartOBDdevFreeMode();
                ...
                case Mode.PIDdetector:
                    Task.Run(() =>
                    {
                        ...
                        for (int i = 1; i < 256; i++)
                        {
                            ...
                            {
                                serialPort.SendRequest(DecToHex(i.ToString()), mode);
